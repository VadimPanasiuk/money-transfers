...
import com.exchange.money.config.SpringRootConfig;
...
public class TransactionControllerTest extends AbstractTestNGSpringContextTests {
    ...
    public void testCreateTransactionReturnsCorrectResultOnSuccess() throws Exception {
        ...
        mockMvc.perform(post("/transactions")
                ...
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(MockMvcResultMatchers.jsonPath("$.status", Matchers.is(CreateTransactionResult.CreationStatus.SUCCESS.toString())))
    ...
    public void testCreateTransactionReturnsErrorCodeOnFailureDueToNonExistentAccounts() throws Exception {
        ...
        mockMvc.perform(post("/transactions")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.status", Matchers.is(CreateTransactionResult.CreationStatus.ACCOUNT_NOT_FOUND.toString())))
                .andExpect(MockMvcResultMatchers.jsonPath("$.detailMessage", Matchers.is(new AccountNotFoundException(10L).getMessage())));
    }
    ...
    public void testExcecutingATransactionReturnsCorrectResultOnSuccess() throws Exception {
        mockMvc.perform(put("/transactions/1/executed")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.transaction.status", Matchers.is(Transaction.TransactionStatus.EXECUTED.toString())))
                .andExpect(MockMvcResultMatchers.jsonPath("$.status", Matchers.is(ExecuteTransactionResult.ExecutionStatus.SUCCESS.toString())))
    ...
    public void testExcecutingATransactionReturnsUnprocessableEntityResponseIfAccountIsNotFound() throws Exception {
        ...
        mockMvc.perform(put("/transactions/1/executed")
                ...
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(jsonPath("$.transaction.id", is(1)))
                .andExpect(MockMvcResultMatchers.jsonPath("$.transaction.status", Matchers.is(Transaction.TransactionStatus.FAILED.toString())))
                .andExpect(MockMvcResultMatchers.jsonPath("$.status", Matchers.is(ExecuteTransactionResult.ExecutionStatus.ACCOUNT_NOT_FOUND.toString())))
    ...
    public void testExcecutingATransactionReturnsNotFoundResponseIfTransactionIsNotFound() throws Exception {
        ...
        mockMvc.perform(put("/transactions/" + transaction1.getId() + "/executed")
                ...
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(jsonPath("$.transaction", isEmptyOrNullString()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.status", Matchers.is(ExecuteTransactionResult.ExecutionStatus.TRANSACTION_NOT_FOUND.toString())))
                .andExpect(MockMvcResultMatchers.jsonPath("$.detailMessage", Matchers.is(new TransactionNotFoundException(1L).getMessage())));
    }
    ...
    public void testExcecutingATransactionReturnsUnprocessableEntityResponseIfAccountHasInsufficientFunds()
        ...
        mockMvc.perform(put("/transactions/" + transaction2.getId() + "/executed")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.transaction.status", Matchers.is(Transaction.TransactionStatus.FAILED.toString())))
                .andExpect(MockMvcResultMatchers.jsonPath("$.status", Matchers.is(ExecuteTransactionResult.ExecutionStatus.INSUFFICIENT_FUNDS.toString())))

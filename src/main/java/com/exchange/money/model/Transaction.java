...
public class Transaction {
    ...
    public Transaction(long id, long sourceId, long destinationId, Amount amount,
        ...
        Assert.checkIsTrue(sourceId > 0, "SourceId can not be zero or negative");
        Assert.checkIsTrue(destinationId > 0, "DestinationId can not be zero or negative");
        Assert.checkIsTrue(id >= 0, "DestinationId can not be zero or negative");
        Assert.checkNotNull(amount, "Amount can not be null");
        this.id = id;
